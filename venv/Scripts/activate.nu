...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Courses\Python\Project\Day82-Portofolio Project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Courses\Python\Project\Day82-Portofolio Project\venv\Scripts\deactivate.nu'
